...
-(id) initWithWinRect: (CGRect)rect andDuckNum:(int)dn andBirdNum:(int)bn andPirrotNum:(int)pn;
{
	if( (self=[super init]) )
    {
        ...
        self.duck.scale *= 0.4*CC_CONTENT_SCALE_FACTOR()*0.5;
        ...
        self.duck_label = [DHLabel labelWithString:duck_str fontName:DHLABEL_FONT fontSize:12];
        ...
        self.bird.scale *= 0.4*CC_CONTENT_SCALE_FACTOR()*0.5;
        ...
        self.bird_label = [DHLabel labelWithString:bird_str fontName:DHLABEL_FONT fontSize:12];
        ...
        self.parrot.scale *= 0.4*CC_CONTENT_SCALE_FACTOR()*0.5;
        ...
        self.parrot_label = [DHLabel labelWithString:parrot_str fontName:DHLABEL_FONT fontSize:12];
